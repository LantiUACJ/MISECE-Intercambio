                            ...
                            <div class="top">
                                ...
                                <div class="menu-items">
                                    <a class="vcenter" href="dashboard-medic-inicio.html">
                                        ...
                                        Inicio</a>
                                    <a class="vcenter" href="dashboard-medic-basic.html">
                                        <i class="material-icons">search</i>
                                        Consulta básica</a>
                                    <a class="vcenter active" href="dashboard-medic-fullfile.html">
                ...
                <div class="data-container">
                    ...
                    <div class="data-content">
                        ...
                        <div class="row simple-form">
                            <div class="col s12">
                                <p>Solicita al paciente <b>Juan</b> el código de verificación </p>
                            </div>
                            <form class="col s12">
                              <div class="row">
                              ...
                              <a href="dashboard-medic-fullfile-file.html" class="waves-effect waves-light btn modal-trigger">
                                <i class="material-icons left">find_in_page</i>Verificar y ver expediente</a>
