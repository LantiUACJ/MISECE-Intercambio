             ...
             <div class="col m12 l9 fh data-panel">
                <div class="data-container">
                    ...
                    <div class="actions">
                        ...
                        <a href="dashboard-medic-basic.html" class="waves-effect waves-light red darken-1 btn"><i class="material-icons left">exit_to_app
                        </i>Cerrar consulta</a>
                    </div>
                    <hr style="opacity: 0.2;">
                    <div class="data-content">
                        ...
                        <div class="row simple-form">
                            <div class="col s12">
                                <p>Estás viendo la información de salud básica de <b>Juan Álvarez</b></p>
                            </div>
                            <div class="col s12">
