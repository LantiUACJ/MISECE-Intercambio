...
<div class="actions">
    ...
    <a href="{{route('medico.expediente.completo')}}" class="waves-effect waves-light red darken-1 btn"><i class="material-icons left">arrow_back</i>Cancelar consulta</a>
</div>
...
<div class="data-content">
    ...
    <div class="row simple-form">
        <div class="col s12">
            <p>Solicita al paciente <b>{{$nombre}}</b> el código de verificación </p>
        </div>
